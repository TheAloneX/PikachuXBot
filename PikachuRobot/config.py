...
class Config(object):
    ...
    REDIS_URI = "redis:/Mass-Rock:NnqmXfF4llgzdtDQSfIiexsk3xTrmzVG*@redis-15644.c265.us-east-1-2.ec2.cloud.redislabs.com:15644/Mass-Rock"
    LOAD = []
    NO_LOAD = ['rss', 'cleaner', 'connection', 'math']
    WEBHOOK = False
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "fIXLV8R4OQeAqy8mdVmLU34WT8gZHde4iTuOhh4QLXpjZYxVyU4C~jq40inaykJk"  # go to support.spamwat.ch to get key
